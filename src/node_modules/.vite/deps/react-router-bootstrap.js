...
} from "./chunk-HZKBGGAQ.js";
import "./chunk-UXJY2BL3.js";
import {
  __commonJS,
  __toCommonJS,
  require_react
...
var require_LinkContainer = __commonJS({
  "node_modules/react-router-bootstrap/LinkContainer.js"(exports) {
    ...
    var _reactRouterDom = (init_react_router_dom(), __toCommonJS(react_router_dom_exports));
    ...
    var LinkContainer = function LinkContainer2(_ref) {
      var children = _ref.children, onClick = _ref.onClick, replace = _ref.replace, to = _ref.to, activeClassName = _ref.activeClassName, className = _ref.className, activeStyle = _ref.activeStyle, style = _ref.style, getIsActive = _ref.isActive, props = _objectWithoutProperties(_ref, _excluded);
...
// dep:react-router-bootstrap
var react_router_bootstrap_default = require_react_router_bootstrap();
export {
  react_router_bootstrap_default as default
};
